...
def check_security(FE_url, BE_url):
    print(category("Checking security:"))
    magento_admin_url(FE_url, BE_url)
    sensitive_urls(FE_url, BE_url)
    SSL_expiration(FE_url)
    admin_users()
...
def magento_admin_url(FE_url, BE_url):
...
def sensitive_urls(FE_url, BE_url):
